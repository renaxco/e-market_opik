        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="col-8">
                ...
                readonly value="{{ $kode }}" name="kode_masuk">
              </div>
            </div>
            <div class="col-6">
          ...
          <div class="row justify-content-end" style="text-align: right;">
              ...
              <div class="col-md-3 mr-md-auto" style="padding-right: 10px;align-content: right;">
                  <input class="form-control col-md-8 col-xs-12" style="margin-left: 80px;" required="required" type="text" id="totalHarga" name="total">
              </div>
          </div>
          <div class="row">
